...
copy_elements1 = document.getElementsByTagName("code")
copy_elements2 = document.getElementsByClassName("example-url")

// console.log(copy_elements1 );

var copy_elements1 = document.getElementsByTagName("code");
Array.from(copy_elements1).forEach(function(element) {
...
var copy_elements2 = document.getElementsByClassName("example-url");
Array.from(copy_elements2).forEach(function(element) {
    element.addEventListener("click", function(event) {
        let copyText = event.target.textContent;
        navigator.clipboard.writeText(copyText).then(function() {
            console.log('Copied to clipboard: ', copyText);
